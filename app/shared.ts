...
export type LineaBanco = { id: string; numeroLinea: number; fecha: string | null; referencia: string | null; descripcion: string; debito: string; credito: string; saldo: string | null; estadoConciliacion: "pendiente" | "conciliada" | "descartada"; movimientoId: string | null };
export type MovimientoConciliable = { id: string; fecha: string; referencia: string | null; concepto: string; monto: number; lineaId: string | null };
export type LineaConciliacion = LineaBanco & { movimiento: MovimientoConciliable | null };
export type Conciliacion = { id: string; reporteId: string; cuentaBancariaNumero: string; cuentaBancariaNombre?: string | null; periodo: string; estado: "borrador" | "aprobada" | "rechazada"; totalBanco: string; totalConciliado: string; totalPendiente: string; lineasConciliadas: number; lineasPendientes: number; movimientosSinConciliar: number; observaciones?: string | null; creadoEn: string; revisadoPorNombre?: string | null; revisadoEn?: string | null; reporteNombre?: string | null };
...
export type DetalleMinuta = { tipo: "debito" | "credito"; cuentaCodigo: string; monto: string };
...
export type DetalleRegistrado = { id: string; movimientoId: string; tipo: "debito" | "credito"; cuentaCodigo: string; cuentaNombre: string; monto: string; orden: number };
