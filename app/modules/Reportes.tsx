...
export default function Reportes({canDownload}:{canDownload:boolean}){
  ...
  async function generar(selected:TipoReporte=tipo){
    // El reporte de minutas se filtra por iglesia y rango de fechas, no por período/comparar: su
    // propio componente hace su propia consulta, aquí solo se cambia la pestaña activa.
    if(selected==="minutas"){ setTipo(selected); setLoading(false); setError(""); return; }
