...
export type ReporteFinanciero = { tipo: TipoReporte; titulo: string; descripcion: string; periodo: number; periodoComparativo?: number; moneda: "NIO"; fuente: "Datos demostrativos"; columnas: string[]; filas: FilaReporte[]; generadoEn: string };
